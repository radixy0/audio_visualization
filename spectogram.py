...
class Options:
    ...
    image = 'spectogram.png'  # image name output
    ...
    def _get_command_line_arguments(self):
        ...
        parser.add_argument('-i', '--image', action='store', dest='image', help='Image output name, defaults to spectogram.png', default='spectogram.png')
